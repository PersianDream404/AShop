...
public static class GetSelectListBrandEndpoint
{
    public class EndPoint : BaseEndpoint, IEndpoint
    {
        public void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapGet($"{ApiInfo.Prefix}/SelectList", handler: async (
                    ...
                    [AsParameters] GetSelectListBrandRequestDto request,
                  [FromServices] IQueryBus _queryBus
                ) =>
            {

                var result = await _queryBus.Send<GetSelectListBrandQuery, PagedList< GetSelectListBrandResponseDto >>
                                 (new GetSelectListBrandQuery(request));
