...
public record CreateOrderCommand(CreateOrderRequestDto Request) : ICommand<bool>;
...
public record UpdateOrderTotalAmountCommand(long OrderId, decimal NewTotalAmount) : ICommand<bool>;
