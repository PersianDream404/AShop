...
{
    public const string ErrorTitle = "خطا";
    public const string SuccessTitle = "موفق";
    ...
    public const string ErrorIn = "خطای نامشخص رخ داده  در  {0} است";
    public const string UploadPicture = "خطا در اپلود عکس {0} رخ داده است";
